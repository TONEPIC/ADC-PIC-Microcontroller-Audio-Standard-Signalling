...
/* ======= Globals======== */
char led_Array[5] = {0b000000,0b000001,0b000011,0b000111,0b100111};
...
{	
    ...
    while(1)
    {
        ...
        ADC_value = ADC_value / 30;
           ...
           { 
              counter = 0x00;
           }else if  (ADC_value >=11 && ADC_value <=30)
           {
                counter = 0x01;
           }else  if (ADC_value >=31 && ADC_value <=59)
           {
               counter = 0x02;  
           }else if (ADC_value >60 && ADC_value <=120)
           {
               counter = 0x03; 
           }else if (ADC_value >=121 && ADC_value <=1024)
           {
              counter = 0x04;  
